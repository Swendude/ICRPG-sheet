...
var $author$project$Main$init = function (_v0) {
	...
	var h = _v0.b;
	var w = _v0.c;
	var _v1 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$decodeCharacter, charValue);
	if (_v1.$ === 'Ok') {
		var _char = _v1.a;
		return _Utils_Tuple2(
			{
				...
				settings: {
					...
					device: $mdgriffith$elm_ui$Element$classifyDevice(
						{height: h, width: w}),
					editingState: $author$project$Main$NotEditing
				}
			},
...
var $author$project$Main$subscriptions = function (_v0) {
	return $elm$browser$Browser$Events$onResize(
		F2(
			function (w, h) {
				return A2($author$project$Main$ScreenResize, h, w);
			}));
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'stats',
				$author$project$Main$encodeStats(item.stats)),
				_Utils_Tuple2(
				'equipped',
				$elm$json$Json$Encode$bool(item.equipped))
			]));
};
var $author$project$Main$encodeNumberProp = function (prop) {
	return $elm$json$Json$Encode$int(prop.value);
};
var $author$project$Main$encodeTextProp = function (prop) {
	return $elm$json$Json$Encode$string(prop.value);
};
...
var $author$project$Main$asClassIn = F2(
	function (_char, newclass) {
		return _Utils_update(
			_char,
			{_class: newclass});
	});
var $author$project$Main$asCoinIn = F2(
	function (_char, newcoin) {
		return _Utils_update(
			_char,
			{coin: newcoin});
	});
var $author$project$Main$asDeathtimerIn = F2(
	function (_char, newvalue) {
		return _Utils_update(
			_char,
			{deathtimer: newvalue});
	});
var $author$project$Main$asDeviceIn = F2(
	function (state, newDevice) {
		return _Utils_update(
			state,
			{device: newDevice});
	});
var $author$project$Main$asEditValueIn = F2(
...
var $author$project$Main$asHoveredIn = F2(
	function (charp, hovered) {
		return _Utils_update(
			charp,
			{hovered: hovered});
	});
var $author$project$Main$asItemsIn = F2(
...
var $author$project$Main$asNumberValueIn = F2(
	function (charp, newvalue) {
		return _Utils_update(
			charp,
			{value: newvalue});
...
var $author$project$Main$updateItemAttribute = F4(
	function (model, attr, value, ix) {
		var _v0 = A2($elm_community$list_extra$List$Extra$getAt, ix, model.character.items);
		if (_v0.$ === 'Just') {
			var item = _v0.a;
			var itemToItems = F2(
				function (ix_, newItem) {
					return A2(
						...
						A2(
							...
							model.character,
							A3($elm_community$list_extra$List$Extra$setAt, ix_, newItem, model.character.items)));
				});
			if (attr.$ === 'ItemName') {
				return A2(
					itemToItems,
...
var $author$project$Main$updateItemStat = F4(
	function (model, stat, value, ix) {
		var _v0 = A2($elm_community$list_extra$List$Extra$getAt, ix, model.character.items);
		if (_v0.$ === 'Just') {
			var oldItem = _v0.a;
			var statsToItem = F2(
				function (ix_, newStat) {
					return A2(
						$author$project$Main$asCharIn,
						model,
						A2(
	...
	function (model, stat, value) {
		var statsToModel = function (newStat) {
			return A2(
				$author$project$Main$asCharIn,
				model,
				A2($author$project$Main$asStatsIn, model.character, newStat));
		};
		var stats = model.character.stats;
		switch (stat.$) {
			case 'Str':
				return statsToModel(
					_Utils_update(
		...
		switch (msg.$) {
			...
			case 'ScreenResize':
				...
				return A2(
					...
					model,
					A2(
						$author$project$Main$asDeviceIn,
						model.settings,
			...
			case 'ToggleItem':
				...
				if (_v23.$ === 'Just') {
					...
					var itemsRemoved = A2($elm_community$list_extra$List$Extra$removeAt, ix, model.character.items);
					...
					case 'Name':
						return A2(
							...
							A2(
								$author$project$Main$asNameIn,
								model.character,
								A2($author$project$Main$asHoveredIn, model.character.name, true)));
					case 'Class':
						return A2(
							$author$project$Main$asCharIn,
							model,
							A2(
								$author$project$Main$asClassIn,
								model.character,
								A2($author$project$Main$asHoveredIn, model.character._class, true)));
					case 'Bioform':
						return A2(
							$author$project$Main$asCharIn,
							model,
					...
					case 'Name':
						return A2(
							...
							A2(
								$author$project$Main$asNameIn,
								model.character,
								A2($author$project$Main$asHoveredIn, model.character.name, false)));
					case 'Class':
						return A2(
							$author$project$Main$asCharIn,
							model,
							A2(
								$author$project$Main$asClassIn,
								model.character,
								A2($author$project$Main$asHoveredIn, model.character._class, false)));
					case 'Bioform':
						return A2(
							$author$project$Main$asCharIn,
							model,
...
var $author$project$Main$updateWithCommands = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'SaveCharacter':
				return _Utils_Tuple2(
					...
					A3(
						...
						model.character.name.value + '.json',
						'application/json',
						$author$project$Main$encodeCharacter(model.character)));
			case 'LoadCharacter':
				return _Utils_Tuple2(
					model,
					A2(
						...
						_List_fromArray(
							['application/json']),
						$author$project$Main$CharacterSelected));
			case 'CharacterSelected':
				...
				return _Utils_Tuple2(
					...
					A2(
						$elm$core$Task$perform,
						$author$project$Main$CharacterLoaded,
						$elm$file$File$toString(file)));
			case 'CharacterLoaded':
				var content = msg.a;
				var _v1 = A2($elm$json$Json$Decode$decodeString, $author$project$Main$decodeCharacter, content);
				if (_v1.$ === 'Ok') {
					var _char = _v1.a;
					return _Utils_Tuple2(
						_Utils_update(
...
var $author$project$Main$Guns = {$: 'Guns'};
...
var $author$project$Main$Ultimate = {$: 'Ultimate'};
...
var $author$project$Main$pickStyle = function (model) {
...
var $author$project$Main$scaled = F2(
	function (model, f) {
		return $elm$core$Basics$round(
			A3(
				$mdgriffith$elm_ui$Element$modular,
				$author$project$Main$pickStyle(model).fontBase,
				1.2,
				f));
	});
					...
					]),
				{
					label: A2(
						...
						_List_fromArray(
							[$mdgriffith$elm_ui$Element$centerX]),
						$mdgriffith$elm_ui$Element$text(label)),
					onChange: $author$project$Main$ChangeItemAttribute(attr),
					placeholder: $elm$core$Maybe$Just(
						A2(
							$mdgriffith$elm_ui$Element$Input$placeholder,
							_List_fromArray(
...
var $author$project$Main$editItemModal = F2(
	function (model, item) {
				...
				A2(
					...
					_List_fromArray(
						[
								...
								[
									...
									_List_fromArray(
										[
											...
											A2($author$project$Main$scaled, model, 2))
										]),
									$mdgriffith$elm_ui$Element$text('Edit item'))
								])),
							A2(
							$mdgriffith$elm_ui$Element$row,
							_List_fromArray(
							...
							_List_fromArray(
								[
									A3($author$project$Main$textEditor, $author$project$Main$ItemName, item.name, 'Name')
								])),
							A2(
							$mdgriffith$elm_ui$Element$row,
							_List_fromArray(
							...
							_List_fromArray(
								[
									A3($author$project$Main$textEditor, $author$project$Main$Description, item.description, 'Description')
								])),
							A2(
							$mdgriffith$elm_ui$Element$row,
							_List_fromArray(
							...
							_List_fromArray(
								[
									...
									A3($author$project$Main$statEditor, $author$project$Main$Guns, item.stats.weapon, 'Guns'),
							...
							_List_fromArray(
								[
									A3($author$project$Main$statEditor, $author$project$Main$Str, item.stats.str, 'Str'),
									A3($author$project$Main$statEditor, $author$project$Main$Dex, item.stats.dex, 'Dex'),
									A3($author$project$Main$statEditor, $author$project$Main$Con, item.stats.con, 'Con'),
									A3($author$project$Main$statEditor, $author$project$Main$Int, item.stats._int, 'Int'),
									A3($author$project$Main$statEditor, $author$project$Main$Wis, item.stats.wis, 'Wis'),
			...
			A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A3($author$project$Main$statEditor, $author$project$Main$Basic, model.character.stats.basic, 'Basic'),
						...
						_List_fromArray(
							[
								A3($author$project$Main$statEditor, $author$project$Main$Str, model.character.stats.str, 'Str'),
								A3($author$project$Main$statEditor, $author$project$Main$Dex, model.character.stats.dex, 'Dex'),
								A3($author$project$Main$statEditor, $author$project$Main$Con, model.character.stats.con, 'Con'),
								A3($author$project$Main$statEditor, $author$project$Main$Int, model.character.stats._int, 'Int'),
								A3($author$project$Main$statEditor, $author$project$Main$Wis, model.character.stats.wis, 'Wis'),
								A3($author$project$Main$statEditor, $author$project$Main$Cha, model.character.stats.cha, 'Cha')
							])),
						A2(
						$mdgriffith$elm_ui$Element$Input$button,
						_List_fromArray(
...
var $author$project$Main$blockRowLabelStyle = _List_fromArray(
	[$mdgriffith$elm_ui$Element$alignLeft]);
...
var $author$project$Main$blockRowStyle = _List_fromArray(
	[
		A2($mdgriffith$elm_ui$Element$spacingXY, 10, 0),
		$mdgriffith$elm_ui$Element$Background$color(
...
var $author$project$Main$blockStyle = _List_fromArray(
	[
...
var $author$project$Main$statBlock = F3(
	function (model, basestat, lootstat) {
		return A2(
			$mdgriffith$elm_ui$Element$row,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text(
							'Base\t' + $elm$core$String$fromInt(basestat)),
							$mdgriffith$elm_ui$Element$text(
							'Loot\t' + $elm$core$String$fromInt(lootstat))
						]))
				]));
	});
var $author$project$Main$effortBlocks = function (model) {
	return _List_fromArray(
		[
			A2(
			$mdgriffith$elm_ui$Element$row,
			$author$project$Main$blockRowStyle,
			_List_fromArray(
				[
					A2(
					$mdgriffith$elm_ui$Element$el,
					$author$project$Main$blockRowLabelStyle,
					$mdgriffith$elm_ui$Element$text('Basic\t(D4)')),
					A2(
					$mdgriffith$elm_ui$Element$el,
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$el,
					$author$project$Main$blockRowLabelStyle,
					$mdgriffith$elm_ui$Element$text('Weapon\t(D6)')),
					A2(
					$mdgriffith$elm_ui$Element$el,
					$author$project$Main$blockRowBlockStyle,
					A3(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$el,
					$author$project$Main$blockRowLabelStyle,
					$mdgriffith$elm_ui$Element$text('Guns \t(D8)')),
					A2(
					$mdgriffith$elm_ui$Element$el,
					$author$project$Main$blockRowBlockStyle,
					A3(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$el,
					$author$project$Main$blockRowLabelStyle,
					$mdgriffith$elm_ui$Element$text('Magic\t(D10)')),
					A2(
					$mdgriffith$elm_ui$Element$el,
					$author$project$Main$blockRowBlockStyle,
					A3(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$el,
					$author$project$Main$blockRowLabelStyle,
					$mdgriffith$elm_ui$Element$text('Ultimate\t(D12)')),
					A2(
					$mdgriffith$elm_ui$Element$el,
					$author$project$Main$blockRowBlockStyle,
					A3(
						$author$project$Main$statBlock,
						model,
						model.character.stats.ultimate,
						function ($) {
							return $.ultimate;
						}(
							$author$project$Main$totalEquippedStats(model.character.items))))
...
var $author$project$Main$LoadCharacter = {$: 'LoadCharacter'};
var $author$project$Main$SaveCharacter = {$: 'SaveCharacter'};
...
var $author$project$Main$headerRow = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
				...
				A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255)),
				$mdgriffith$elm_ui$Element$padding(5),
				A2($mdgriffith$elm_ui$Element$spacingXY, 12, 0)
			]),
		_List_fromArray(
			[
				A2(
					...
					[$mdgriffith$elm_ui$Element$alignRight]),
				{
					...
					onPress: $elm$core$Maybe$Just($author$project$Main$SaveCharacter)
				}),
				A2(
				$mdgriffith$elm_ui$Element$Input$button,
				_List_fromArray(
...
var $author$project$Main$printTextAttribute = function (attr) {
	switch (attr.$) {
		case 'Name':
			return 'Name';
		case 'Class':
						...
						]),
					{
						...
						placeholder: $elm$core$Maybe$Just(
							A2(
								$mdgriffith$elm_ui$Element$Input$placeholder,
								_List_Nil,
								$mdgriffith$elm_ui$Element$text('Start typing'))),
						text: prop.value
					})
				]));
		var labelEl = A2(
			...
			function () {
				var _v1 = prop.value;
				if (_v1 === '') {
					return $mdgriffith$elm_ui$Element$text('Start typing');
				} else {
					return $mdgriffith$elm_ui$Element$text(prop.value);
				}
			}());
		var buttonStyle = prop.hovered ? _List_fromArray(
			[
				$mdgriffith$elm_ui$Element$scrollbarX,
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$Events$onMouseEnter(
				$author$project$Main$Hovered(prop.id)),
				$mdgriffith$elm_ui$Element$Events$onMouseLeave(
				$author$project$Main$Unhovered(prop.id))
			]) : _List_fromArray(
			[
				$mdgriffith$elm_ui$Element$clip,
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
			...
			[
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$el,
						_List_Nil,
						$mdgriffith$elm_ui$Element$text('Lifeform :')),
						A3(
						$author$project$Main$editableTextField,
						_List_fromArray(
							[
...
var $author$project$Main$editModifier = function (ix) {
	return A2(
		$mdgriffith$elm_ui$Element$Input$button,
		_List_Nil,
		{
			...
			onPress: $elm$core$Maybe$Just(
				$author$project$Main$EditItem(ix))
		});
};
...
var $author$project$Main$printStat = function (val_stat) {
	var val = val_stat.a;
	var stat = val_stat.b;
	return (stat > 0) ? $elm$core$Maybe$Just(
		val + (' +' + $elm$core$String$fromInt(stat))) : ((stat < 0) ? $elm$core$Maybe$Just(
...
var $author$project$Main$itemRow = F4(
	function (model, modifierButton, editButton, _v0) {
		var ix = _v0.a;
		var item = _v0.b;
		return A2(
			$mdgriffith$elm_ui$Element$row,
...
var $author$project$Main$itemsIndexed = function (b) {
	return A2(
		$elm$core$Basics$composeL,
		$elm$core$List$filter(
			A2(
...
var $author$project$Main$newItemButton = F2(
	function (model, equipped) {
		return A2(
			$mdgriffith$elm_ui$Element$Input$button,
			_List_fromArray(
				[$mdgriffith$elm_ui$Element$alignRight]),
			{
				label: A2(
					...
					$mdgriffith$elm_ui$Element$text('Add item')),
				onPress: $elm$core$Maybe$Just(
					$author$project$Main$NewItem(equipped))
			});
	});
var $author$project$Main$ToggleItem = function (a) {
	return {$: 'ToggleItem', a: a};
};
var $author$project$Main$stateModifier = F2(
	function (label, ix) {
		return A2(
			$mdgriffith$elm_ui$Element$Input$button,
			_List_Nil,
			{
				label: A2(
					...
					$mdgriffith$elm_ui$Element$text(label)),
				onPress: $elm$core$Maybe$Just(
					$author$project$Main$ToggleItem(ix))
			});
	});
var $author$project$Main$itemCol = F4(
	function (model, equippedState, label, modifyLabel) {
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
							...
							$mdgriffith$elm_ui$Element$text(
								label + ($elm$core$String$fromInt(
									$elm$core$List$length(
										A2($author$project$Main$itemsIndexed, equippedState, model.character.items))) + '/10'))),
							A2($author$project$Main$newItemButton, model, equippedState)
						])),
					A2(
					$mdgriffith$elm_ui$Element$column,
					_List_fromArray(
					...
					A2(
						$elm$core$List$map,
						A3(
							$author$project$Main$itemRow,
							model,
							$author$project$Main$stateModifier(modifyLabel),
							$author$project$Main$editModifier),
						A2($author$project$Main$itemsIndexed, equippedState, model.character.items)))
				]));
	});
...
var $author$project$Main$showErrorModal = F2(
	function (model, err) {
		return $mdgriffith$elm_ui$Element$inFront(
			A2(
				$mdgriffith$elm_ui$Element$el,
...
var $author$project$Main$spacerRow = A2(
	$mdgriffith$elm_ui$Element$el,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
...
var $author$project$Main$statBlocks = function (model) {
	return _List_fromArray(
		[
			A2(
			$mdgriffith$elm_ui$Element$row,
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$el,
					$author$project$Main$blockRowLabelStyle,
					$mdgriffith$elm_ui$Element$text('Dex')),
					A2(
					$mdgriffith$elm_ui$Element$el,
					$author$project$Main$blockRowBlockStyle,
					A3(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$el,
					$author$project$Main$blockRowLabelStyle,
					$mdgriffith$elm_ui$Element$text('Int')),
					A2(
					$mdgriffith$elm_ui$Element$el,
					$author$project$Main$blockRowBlockStyle,
					A3(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$el,
					$author$project$Main$blockRowLabelStyle,
					$mdgriffith$elm_ui$Element$text('Wis')),
					A2(
					$mdgriffith$elm_ui$Element$el,
					$author$project$Main$blockRowBlockStyle,
					A3(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$el,
					$author$project$Main$blockRowLabelStyle,
					$mdgriffith$elm_ui$Element$text('Cha')),
					A2(
					$mdgriffith$elm_ui$Element$el,
					$author$project$Main$blockRowBlockStyle,
					A3(
...
var $author$project$Main$storyRow = function (model) {
		...
		switch (_v0.$) {
			...
			case 'EditingItem':
				...
				if (_v1.$ === 'Just') {
					...
					return _List_fromArray(
						[
							A2($author$project$Main$editItemModal, model, item)
						]);
				} else {
					return _List_Nil;
				}
			case 'ShowError':
				...
				return _List_fromArray(
					[
						A2($author$project$Main$showErrorModal, model, err)
					]);
			default:
				return _List_Nil;
		}
		...
		A2(
			...
			_Utils_ap(
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$width(
						$author$project$Main$pickStyle(model).mainWidth),
						$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
						$mdgriffith$elm_ui$Element$Background$color(
						A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255)),
						A2($mdgriffith$elm_ui$Element$paddingXY, 21, 23),
			...
			_List_fromArray(
				[
					$author$project$Main$headerRow(model),
					...
					_List_fromArray(
						[
							A4($author$project$Main$itemCol, model, true, 'Equipped ', 'Carry'),
							A4($author$project$Main$itemCol, model, false, 'Carried ', 'Equip')
						])),
					$author$project$Main$spacerRow,
					A2(
					$mdgriffith$elm_ui$Element$row,
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$text('Made '),
									A2(
										...
										]),
									{
										label: A2(
											$mdgriffith$elm_ui$Element$el,
											_List_Nil,
											$mdgriffith$elm_ui$Element$text('Swendude')),
					...
					{description: 'For use with ICRPG', src: 'public/icrpg.png'})
				])));
};
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	A2(
		...
		A2($elm$json$Json$Decode$index, 0, $elm$json$Json$Decode$value)))(0)}});}(this));