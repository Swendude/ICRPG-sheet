...
var $author$project$Main$asEditingStatsIn = F2(
...
var $author$project$Main$ChangeStat = F2(
	function (a, b) {
		return {$: 'ChangeStat', a: a, b: b};
	});
					...
					]),
				{
					label: A2(
						...
						_List_fromArray(
							[$mdgriffith$elm_ui$Element$centerX]),
						$mdgriffith$elm_ui$Element$text(label)),
					onChange: $author$project$Main$ChangeStat(stat),
...
var $author$project$Main$equippedItemsIndexed = A2(
	$elm$core$Basics$composeL,
	$elm$core$List$filter(
		A2(
			$elm$core$Basics$composeL,
...
var $author$project$Main$newItemRow = A2(
	$mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[
			A2($mdgriffith$elm_ui$Element$spacingXY, 10, 0),
		...
		A2(
			...
			_Utils_ap(
				A2(
					...
					$author$project$Main$equippedItemsIndexed(_char.items)),
				_List_fromArray(
...
var $author$project$Main$carriedItemsIndexed = A2(
	$elm$core$Basics$composeL,
	$elm$core$List$filter(
		A2(
			$elm$core$Basics$composeL,
			...
			$elm$core$Tuple$second)),
	$elm$core$List$indexedMap($elm$core$Tuple$pair));
var $author$project$Main$carriedModifier = function (ix) {
	return A2(
		$mdgriffith$elm_ui$Element$Input$button,
		_List_Nil,
		{
	...
	return A2(
		...
		A2(
			...
			A2(
				...
				$author$project$Main$carriedItemsIndexed(_char.items))));
};
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Main.Item":{"args":[],"type":"{ name : String.String, description : String.String, stats : Main.Stats, equipped : Basics.Bool }"},"Main.Stats":{"args":[],"type":"{ str : Basics.Int, dex : Basics.Int, con : Basics.Int, wis : Basics.Int, int : Basics.Int, cha : Basics.Int, basic : Basics.Int, weapon : Basics.Int, magic : Basics.Int, ultimate : Basics.Int, armor : Basics.Int, hearts : Basics.Int }"}},"unions":{"Main.Msg":{"args":[],"tags":{"Increment":[],"Decrement":[],"MakeTextEditable":["Main.TextAttribute"],"UpdateTextAttr":["Main.TextAttribute","String.String"],"DisableTextEditing":["Main.TextAttribute"],"MakeNumberEditable":["Main.NumberAttribute"],"DisableNumberEditing":[],"IncreaseNumberAttribute":["Main.NumberAttribute"],"DecreaseNumberAttribute":["Main.NumberAttribute"],"UpdateEditField":["Main.NumberAttribute","String.String"],"EditBaseStats":[],"ChangeStat":["Main.Stat","String.String"],"ToggleItem":["Basics.Int"],"Hovered":["Main.TextAttribute"],"Unhovered":["Main.TextAttribute"],"ChangeItemStat":["Basics.Int","Main.Item","Basics.Bool","Main.Stat","String.String"],"EditItem":["Basics.Int","Basics.Bool"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Main.NumberAttribute":{"args":[],"tags":{"Coin":[],"Hitpoints":[],"Deathtimer":[]}},"Main.Stat":{"args":[],"tags":{"Str":[],"Dex":[],"Con":[],"Wis":[],"Int":[],"Cha":[],"Armor":[],"Basic":[],"Weapon":[],"Magic":[],"Ultimate":[],"Hearts":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Main.TextAttribute":{"args":[],"tags":{"Name":[],"Story":[],"Class":[],"Bioform":[]}}}}})}});}(this));